 ...
 */
export function derivePresence(stored: StoredPresence | undefined, lastSeenAt: string | null | undefined, now: number): PresenceStatus {
 ...
 */
export function formatLastSeen(lastSeenAt: string | null | undefined, now: number): string {
 ...
 */
export function presenceLabel(status: PresenceStatus, lastSeenAt: string | null | undefined, now: number): string {
  switch (status) {
    case 'online':
