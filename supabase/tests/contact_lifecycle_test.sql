...
SELECT function_privs_are(
  'public', 'restore_contact', ARRAY['uuid'], 'authenticated', ARRAY[]::TEXT[],
  'restore remains disabled for authenticated users');
SELECT function_privs_are(
...
VALUES
  ('00000000-0000-0000-0000-000000000311', '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000201', 'pending'),
  ('00000000-0000-0000-0000-000000000312', '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000201', 'sent'),
  ('00000000-0000-0000-0000-000000000313', '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000201', 'delivered'),
  ('00000000-0000-0000-0000-000000000314', '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000201', 'read'),
  ('00000000-0000-0000-0000-000000000315', '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000201', 'replied'),
  ('00000000-0000-0000-0000-000000000316', '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000201', 'failed'),
  ('00000000-0000-0000-0000-000000000317', '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000203', 'pending');
