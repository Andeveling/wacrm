...
describe('lastNDayKeys', () => {
  ...
  it('rolls back across a month boundary', () => {
    vi.setSystemTime(new Date('2026-05-02T08:00:00'));
    expect(lastNDayKeys(4)).toEqual(['2026-04-29', '2026-04-30', '2026-05-01', '2026-05-02']);
  });
});
...
describe('mondayIndex', () => {
  ...
  it('aligns with DOW_SHORT_MON_FIRST labels', () => {
    expect(DOW_SHORT_MON_FIRST[mondayIndex(new Date('2026-05-18'))]).toBe('Mon');
    expect(DOW_SHORT_MON_FIRST[mondayIndex(new Date('2026-05-24'))]).toBe('Sun');
  });
});
