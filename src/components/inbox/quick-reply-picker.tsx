 ...
 */
export function QuickReplyPicker({ open, onOpenChange, onPick }: QuickReplyPickerProps) {
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="max-h-[60vh] overflow-y-auto">
          {loading ? (
            ...
            <p className="py-8 text-center text-muted-foreground text-sm">{t('quickRepliesEmpty')}</p>
          ) : (
                ...
                <li key={qr.id}>
                  ...
                  >
                    ...
                    <span className="min-w-0 flex-1">
                      <span className="block truncate font-medium text-foreground text-sm">{qr.title}</span>
