    ...
    <>
      ...
      <aside
        className={cn(
          ...
          'fixed inset-y-0 left-0 z-40 flex h-full w-64 flex-col border-border border-r bg-card',
                ...
                <li key={item.href}>
                  <Link
                    ...
                    className={cn(
                      ...
                      'flex items-center gap-3 rounded-lg px-3 py-2.5 font-medium text-sm transition-colors lg:py-2',
                  ...
                  >
                    ...
                    {item.beta && (
                      <span
                        role="img"
                        aria-label={t('beta')}
                        className="rounded-full border border-amber-500/40 bg-amber-500/10 px-1.5 py-0.5 font-semibold text-[9px] text-amber-300 uppercase tracking-wider"
                      >
                        {t('beta')}
                      </span>
                    )}
                    {showUnreadDot && (
                      <span role="img" aria-label={t('unreadConversations', { count: totalUnread })} className="relative flex h-2 w-2">
                    ...
                    {showNotificationBadge && (
                      <span
                        ...
                        className="flex h-5 min-w-5 items-center justify-center rounded-full bg-primary px-1 font-semibold text-[10px] text-primary-foreground"
                      >
              ...
              {accountRole
                ? // Always render the chip — owners used to be
                  ...
                  (() => {
                    ...
                    return (
                      <span
                        className={`ml-auto inline-flex shrink-0 items-center gap-1 rounded-full border px-1.5 py-0.5 font-medium text-[10px] uppercase tracking-wider ${meta.className}`}
                      >
