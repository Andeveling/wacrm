...
import { DEFAULT_MODE, DEFAULT_THEME, isMode, isThemeId, MODE_STORAGE_KEY, type Mode, STORAGE_KEY, type ThemeId } from '@/lib/themes';
...
export function ThemeProvider({ children }: { children: ReactNode }) {
  ...
  return <ThemeContext.Provider value={{ theme, setTheme, mode, setMode, toggleMode }}>{children}</ThemeContext.Provider>;
}
